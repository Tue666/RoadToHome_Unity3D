...
namespace MagicalFX
{
	public class FX_Camera : MonoBehaviour
	{
		...
		void Update ()
		{
			...
			this.transform.localPosition = positionTemp + new Vector3 (Mathf.Cos (Time.time * 80) * forcePower.x, Mathf.Cos (Time.time * 80) * forcePower.y, Mathf.Cos (Time.time * 80) * forcePower.z);
		}
	}
